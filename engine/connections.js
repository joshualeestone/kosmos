...
function blockBody() {
  return [
    ...
    'connected too, each with an API key. Those four can be connected today.',
    ...
    'Gemini and Grok are the exception: Kosmos does not install their terminal',
    'agents yet, so they have to be on this computer already, and the screen',
    ...
    'Gemini and Grok are connected with a key, in Settings, AI Models, Add a',
    'provider. Each person uses their own account or their own',
