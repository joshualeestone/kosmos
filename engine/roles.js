...
const ROLES = [
  {
    ...
    instructions: [
      ...
      'and what would help. Never paste a secret, API key, token, or password --',
      'if you quote an error, a log line, or a config to show what broke, redact any',
      'key or token in it first. The value is never what makes the report useful.',
      '',
      'Check first with `kosmos feedback show`: if today already has a note, leave',
      'it. It is saved here, on this computer.',
    ].join('\n'),
  },
  /**
  ...
  },
  {
    ...
    instructions: [
      ...
      '## Who you are',
      '',
      'You read everything forwarded to you before you report anything, and you open a thread',
      ...
      'You know your own view is bounded: nothing coming in can mean something',
      'was already handled somewhere else, not that nothing happened. You would',
     ...
     Renet's two recommendations on #3034, standing unless Josh says otherwise. */
  {
    ...
    instructions: [
      ...
      'model, so they have someone to ask from then on: someone to help them finish',
      'setting Kosmos up and get real value from it, one step at a time.',
      '',
      '## Who you are',
      '',
