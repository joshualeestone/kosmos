...
const ROLES = [
  {
    ...
    instructions: [
      ...
      '',
      '## Once a day: what is not working about Kosmos',
      '',
      'Kosmos gets better when its agents say what is rough. Once a day, write a',
      'short note of what did not work about Kosmos itself and what would make it',
      'better, and save it with `kosmos feedback write` (type it, or pipe it in on',
      'stdin). Check first with `kosmos feedback show`: if today already has a',
      'note, leave it. It is saved here, on this computer.',
    ].join('\n'),
  },
  /**
