...
function blockBody(dir) {
  ...
  return [
    ...
    'ask you for one in a direct conversation, save it in your Files folder, unless',
    'they tell you where to put it or it is an existing file you are changing (then',
    'it goes where they said, or stays where it is), or it belongs to one of your',
    'projects (see the next paragraphs; if you are on no projects, it always goes',
    'here):',
    '',
    '`' + where + '`',
    '',
    ...
    'do not guess another: save it in your Files folder, say you are not on that',
