...
function blockBody(dir) {
  ...
  return [
    ...
    'This Files folder is inside your own folder, and it is where "your own folder"',
    'points for a file made for the person, wherever else these instructions use that',
    'phrase. Create the folder if it is not there yet. Keeping what you make in a',
    'direct conversation in one place means they always know where to find it: Kosmos',
    'lists what is in it on your page, where they can open it. Save files directly in',
    'it, not in subfolders: the page lists only what sits at the top of the folder.',
    '',
    ...
    'them in one line where you put it: which project, and the file\'s name. If no',
    'folder is listed for that project, treat it as unclear, as below.',
    '',
    ...
    'says so, ask which project it belongs to, so they can have you move it. The file',
    'is never left unsaved while you wait for an answer.',
    '',
