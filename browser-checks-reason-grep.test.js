...
test('every emit site in every check prints a line the gate can quote', () => {
  ...
  /* 33 after kosmos#2055 added render-update-abort-2055.js (one SHAPE-1 check() finding-emit site, confirmed quotable). 32 after kosmos#2023 added render-board-signin-403-2023.js, whose `check()`
