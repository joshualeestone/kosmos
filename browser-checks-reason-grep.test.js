...
test('every emit site in every check prints a line the gate can quote', () => {
  ...
  // 32 after kosmos#2020 added render-optout-403-2020.js, whose check() helper prints
  // `${pass ? 'PASS' : 'FAIL'}  ${name}` - one SHAPE-4 finding-emit, confirmed quotable.
  const EXPECTED_SITES = 32;
