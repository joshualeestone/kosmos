...
test('every emit site in every check prints a line the gate can quote', () => {
  ...
  //                              +2: render-firstrun-openai-sub-2621.js (its r.error FAIL-emit + the problems FAIL-emit loop, #2621)
...
test('every catch/launch emit prints a line the gate can quote (#1864)', () => {
  ...
  //                                   +1: render-firstrun-openai-sub-2621.js (its could-not-start-a-browser launch catch, #2621)
