...
const IDS = ['acct-add-modal', 'acct-add-dialog', 'acct-add-t', 'acct-add-in', 'acct-provider-field', 'acct-claude-flow',
  'acct-openai-flow', 'acct-apikey-flow', 'acct-grok-flow', 'acct-gemini-flow', 'acct-add-acts', 'acct-success', 'acct-success-say', 'acct-success-close',
...
function makeShow(modalHidden) {
  ...
  dom.els.get('acct-grok-flow').hidden = false;   // #3391 part 2: shown, so the hide below is observed, not inherited
  dom.els.get('acct-gemini-flow').hidden = false;   // #3998: likewise for the Gemini subscription flow
...
test('kosmos#1656: on an OPEN modal, success shows, names the account, and hides the sign-in controls', () => {
  ...
  for (const id of ['acct-add-t', 'acct-add-in', 'acct-provider-field', 'acct-claude-flow', 'acct-openai-flow', 'acct-apikey-flow', 'acct-grok-flow', 'acct-gemini-flow', 'acct-add-acts']) {
