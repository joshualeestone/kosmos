...
const IDS = ['acct-add-modal', 'acct-add-dialog', 'acct-add-t', 'acct-add-in', 'acct-provider-field', 'acct-claude-flow',
  'acct-openai-flow', 'acct-apikey-flow', 'acct-grok-flow', 'acct-add-acts', 'acct-success', 'acct-success-say', 'acct-success-close',
...
test('kosmos#1656: on an OPEN modal, success shows, names the account, and hides the sign-in controls', () => {
  ...
  for (const id of ['acct-add-t', 'acct-add-in', 'acct-provider-field', 'acct-claude-flow', 'acct-openai-flow', 'acct-apikey-flow', 'acct-grok-flow', 'acct-add-acts']) {
