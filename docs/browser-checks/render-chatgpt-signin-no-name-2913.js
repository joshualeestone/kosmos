 ...
 *
 * Browser-check-surface: acct-openai-sub-step acct-openai-sub-label acct-openai-sub-go fr-openai-sub-step fr-openai-sub-label fr-openai-sub-go acct-claude-key-label name-is-optional
 */
