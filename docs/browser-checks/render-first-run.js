...
const SHOTS = [
  ...
  { name: 'firstrun-fleet-create', at: '#fr-fleet', first: FLEET_CREATE, found: FOUND_NONE, scan: SCAN_NONE, expect: /ready to start using Kosmos/i, expectBody: /choose New agent, then pick the Import option\./ },
