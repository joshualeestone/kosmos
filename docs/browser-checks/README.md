...
| `render-dm-sideways-3969.js` | kosmos#3969 (#718): the agent chat on a phone held sideways. HERMETIC (file://, fetch stubbed, touch emulated). At 640x360, 740x360, 667x375 and 852x393 (touch, landscape, at most 30rem tall, narrower than 56rem), light and dark: no page scroll down or sideways, at least 50px of the conversation on screen, the message box and Post on screen, the Profile tab a 44px target. Controls: portrait 375x667 and 393x852 keep the All agents link, search row and avatar; an 800x400 window with a mouse does not get the sideways rules. Fails if it ran any number of checks other than 46 per engine. `KOSMOS_PAGE=<index.html>` runs it against another build. WebKit is an engine approximation, not Safari. |
