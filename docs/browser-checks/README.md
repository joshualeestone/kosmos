...
| `render-create-prefs-3081.js` | #3081: Create an agent remembers the last provider, account and model. Makes an agent with a non-default account and model (the create answer is stubbed, nothing launches), reopens Create after a reload, and asserts both come back pre-selected and can still be changed. Control: a fresh page has no remembered choice. |
