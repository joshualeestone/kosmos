...
(async () => {
  ...
  try {
    ...
    chk(await page.evaluate(() => (document.querySelector('#asp-th .asp-m.him.asp-open') || {}).textContent === 'Hi I\'m Josh, an AI Assistant to help you get your Kosmos setup. What can I help you with?'), 'H2 and opens with the guide\'s own first message, Josh\'s words (#3738, #3947)');
