...
(async () => {
  ...
  console.log('render-trust-restart-0644: the Trust & Restart button POSTs to the URL-encoded /trust-and-restart route and surfaces the route\'s `because` on success and on a refusal, with a friendly fallback on a network failure.');
})();
