...
test('the two Save buttons on the agent panel say which they are', () => {
  ...
  assert.equal((PAGE.match(/>Save</g) || []).length, 5,
  ...
  /* The third (settings-nav, 2026-08-23) is the Your name field's, the fourth
     (#1668) is the Your time zone field's, and the fifth (#1724) is the Automation
     auto-handoff field's, all on the Settings page; named for the same reason,
     pinned here so the count stays explained. */
