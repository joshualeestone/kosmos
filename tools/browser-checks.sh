...
if boot_board "$sb7" "$P8"; then
  ...
  # #3048: render-scan-board.js was removed with the home disk-scan panel it tested.
  ...
  # the right arm under a forced-refusal perturbation before wiring (the #812 rule).
  run_one "render-adopt-1531"   node docs/browser-checks/render-adopt-1531.js "$B8"
  ...
  # #2617: the Token Usage page is the graphical value view (four class cards, a
  # shared-axis trend chart, an output-derived money box, the table), not a plain
...
# page): own mktemp roots, OS-chosen port via srv.start(0), server.js in-process,
# fleet.install, runs bare. Proven standalone 5/5 green, and proven RED against the
...
# pre-#1994 page (10 of 12 arms red: tz select absent, name box full-width, reach copy
# present, Continue POSTs no timezone), which is the arm that makes the 12 mean anything.
...
# anything.
# render-detail-ring-1915 joins the same way (#1915, the memory ring on the detail
# avatar): own mktemp roots, OS-chosen port via srv.start(0), server.js in-process,
# fleet.install, runs bare. It sets a known reading on the open agent's LAST entry
# and re-drives the real openDetail wire, then reads the rendered #d-ring. Proven RED
# by dropping the one openDetail wire line (all eight "a reading renders a ring" arms
...
for n in live-connect render-agent-nav render-connlost-reconnect-3410 render-account-problem-3723 render-create-prefs-3081 render-agent-files-3614 render-tasks-view-3559 render-busy-line render-busy-anim-3421 render-room-busy-scope-2882 render-reauth-reach-1918 render-account-badge-1921 render-disconnect-stop-2570 render-account-name-2095 render-account-dup-reauth-2584 render-observed-consumers-1959 render-workchip-zero-2157 render-createnav-2190 render-head-row render-room-scroll render-talk-anchor-1926 render-made-before render-detail-header-1841 render-start-agent-3410 render-detail-ring-1915 render-org-rings-2576 render-dm-badges-2863 render-nav-badges-3216 render-agentpage-fullwidth-2012 render-engmode-gate-2131 render-firstrun-namestep-1994wiz render-firstrun-enter-2186 render-firstrun-connect-box-2187 render-firstrun-connect-fires render-firstrun-access-onebox render-firstrun-stepcap-gear-0640 render-firstrun-openai-connectbox-2241 render-firstrun-grok-3386 render-conn-top-3708 render-firstrun-keyed-connect-3658 render-keyed-install-3713 render-no-conflict-3729 render-grok-subscription-3391 render-firstrun-openai-sub-2621 render-chatgpt-signin-no-name-2913 render-settings-openai-goldbox render-claude-connect-choice-2433 render-connect-win32-install-570 render-win32-board-copy render-sound-master-2436 render-build-marker-2066 render-openai-only-2096 render-picker-provider-2097 render-create-openai-model-2140 render-detail-openai-model-2140 render-firstrun-model-continue-2134 render-firstrun-s6-2037 render-tophead-consolidated-2282 render-chip-filters-3423 render-org-drag render-pjsettings render-pjcreate-nav-3134 render-settings-nav render-plus-gate-1615 render-plus-signin-3478 render-prompter-label-1843 render-recommender-live-3595 render-assigner-live-3595 render-restarting-2019 render-talk-search render-talk render-agentdm-3414 render-talk-fill-2622 render-help-tips-3574 render-assistant-bubble-3034 render-assistant-hosted-3660 render-agent-msg-gray-2805 render-room-msgbox-2806 render-dm-multiline-3208 render-tasks render-subview-cleanup-3502 render-url-state render-memory-controls render-model-change render-model-restart-interstitial render-restart-kloader-2831 render-handoff-restart-3492 render-pjadd-back-2850 render-pjmode-style-3495 render-reassign-restart-2829 render-reassign-update-3050 render-alltasks emoji-picker-2254 render-composer-reset render-composer-stroke render-type-to-focus-3283 render-msg-counter-3403 render-agent-lines render-long-title render-title-descender-3438 render-project-rows render-richtext-2067 render-richtext-room-2239 render-reactions-2255 render-dm-reactions-3650 render-dm-phone-718 render-firstrun-import-1652 render-firstrun-scan-on-grant-1652 render-firstrun-wizard-flow render-import-add-inplace-2419 render-addmem-flash-2429 render-bubblepop-2407 render-subprojects-1994 render-cons-tree-2929 render-cluster-reorder-2929 render-consolidated-settings-2842 render-consolidated-newagent-3053 render-consolidated-projects-3052 render-project-members-3387 render-user-menu-3051 render-firstrun-reentry-3359 render-projects-roadmap-3276 render-pj-clear-2575 render-autohello-2686 render-autohello-switch-2716 render-worlds-switcher-1704 render-worldswitch-2238 render-worldsw-abandon-2628 render-worldsw-lockout-3055 render-worldrename-1704 render-world-import-2563 render-worldsw-height-2350 render-emoji-mute-2357 render-pjmsg-prewrap-2294 render-model-spinners-2365 render-workindicator-2146 render-plus-blue-1615 render-trust-restart-0644 render-open-terminal-0644 render-provider-combobox-1040 render-provider-order-3651 render-gemini-logo-3422 render-inline-field-errors-2606 render-restore-dircheck-2615 render-frnav-2647 render-remove-force-2651 render-home-discovery-removed-3048 render-profile-field-widths-2697 render-project-needsyou-2699 render-reach-mark-3212 render-needsyou-dealarm-2808 render-waiting-phone-718 render-codex-account-picker-2811 render-mention-blue-2922 render-worldhide-2935 render-openai-install-refusal render-fed-plus-gate render-swarm-ui-3564; do
...
if boot_board_rich "$sbr" "$P11"; then
  ...
  # #3048: render-found-board.js was removed with the home found panel it tested.
  # #2023: a protected-read 403 must render as not-signed-in, not "cannot read".
  ...
  FAILED+=("render-org-chart render-not-running render-list-row render-fields render-board-signin-403-2023 render-update-abort-2055 render-survival (rich board did not boot)")
fi
