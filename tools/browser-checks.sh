...
for n in live-connect render-agent-nav render-busy-line render-room-busy-scope-2882 render-reauth-reach-1918 render-account-badge-1921 render-disconnect-stop-2570 render-account-name-2095 render-account-dup-reauth-2584 render-observed-consumers-1959 render-workchip-zero-2157 render-createnav-2190 render-head-row render-room-scroll render-talk-anchor-1926 render-made-before render-detail-header-1841 render-detail-ring-1915 render-org-rings-2576 render-dm-badges-2863 render-nav-badges-3216 render-agentpage-fullwidth-2012 render-engmode-gate-2131 render-firstrun-namestep-1994wiz render-firstrun-enter-2186 render-firstrun-connect-box-2187 render-firstrun-connect-fires render-firstrun-access-onebox render-firstrun-stepcap-gear-0640 render-firstrun-openai-connectbox-2241 render-firstrun-openai-sub-2621 render-chatgpt-signin-no-name-2913 render-settings-openai-goldbox render-claude-connect-choice-2433 render-connect-win32-install-570 render-win32-board-copy render-sound-master-2436 render-build-marker-2066 render-openai-only-2096 render-picker-provider-2097 render-create-openai-model-2140 render-detail-openai-model-2140 render-firstrun-model-continue-2134 render-firstrun-s6-2037 render-tophead-consolidated-2282 render-memory-words render-org-drag render-pjsettings render-pjcreate-nav-3134 render-settings-nav render-plus-gate-1615 render-prompter-label-1843 render-restarting-2019 render-talk-search render-talk render-talk-fill-2622 render-agent-msg-gray-2805 render-room-msgbox-2806 render-dm-multiline-3208 render-tasks render-url-state render-memory-controls render-model-change render-model-restart-interstitial render-restart-kloader-2831 render-pjadd-back-2850 render-reassign-restart-2829 render-reassign-update-3050 render-alltasks emoji-picker-2254 render-composer-reset render-type-to-focus-3283 render-agent-lines render-long-title render-project-rows render-richtext-2067 render-richtext-room-2239 render-reactions-2255 render-firstrun-import-1652 render-firstrun-scan-on-grant-1652 render-firstrun-wizard-flow render-import-add-inplace-2419 render-addmem-flash-2429 render-bubblepop-2407 render-subprojects-1994 render-cons-tree-2929 render-cluster-reorder-2929 render-consolidated-settings-2842 render-consolidated-newagent-3053 render-user-menu-3051 render-projects-roadmap-3276 render-pj-clear-2575 render-qask-clear-2808 render-autohello-2686 render-worlds-switcher-1704 render-worldswitch-2238 render-worldsw-abandon-2628 render-worldsw-lockout-3055 render-worldrename-1704 render-world-import-2563 render-worldsw-height-2350 render-emoji-mute-2357 render-pjmsg-prewrap-2294 render-model-spinners-2365 render-workindicator-2146 render-plus-blue-1615 render-trust-restart-0644 render-open-terminal-0644 render-provider-combobox-1040 render-inline-field-errors-2606 render-restore-dircheck-2615 render-frnav-2647 render-remove-force-2651 render-home-discovery-removed-3048 render-profile-field-widths-2697 render-project-needsyou-2699 render-reach-mark-3212 render-needsyou-dealarm-2808 render-codex-account-picker-2811 render-mention-blue-2922 render-worldhide-2935 render-openai-install-refusal render-fed-prod-gate-3330; do
