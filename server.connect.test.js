 ...
 * three tests are the route-layer mirror of the engine's #1560 trio
 * (NONE / CONNECTED-agree / UNKNOWN). The seam is `subscription.setRunner` (the
 * same seam the /api/accounts live tests below use).
 */
