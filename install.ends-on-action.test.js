...
// #2073: app-only. The "here is your dashboard" success line is now "Open the
// Kosmos app ..." (the app is the dashboard); the old "Your dashboard: http://"
// line was demoted to an advanced note. The position property is unchanged: the
// action must still come AFTER this success line.
const DASHBOARD = SETUP.lastIndexOf('Open the Kosmos app from your Applications folder');
...
test('nothing that sounds like success comes after it', () => {
  ...
  for (const claim of ['Kosmos is running', 'Open the Kosmos app', 'installed successfully', 'Installation complete']) {
