...
const EXCUSED = {
  ...
  setBrowserFinder: 'test seam (#3288): replaces engine/win32signin.js\'s default-browser lookup, so a suite never reads this PC\'s registry and can pin the BROWSER the sign-in is given. Production uses defaultBrowserProgram.',
