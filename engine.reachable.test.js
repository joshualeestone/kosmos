...
const EXCUSED = {
  ...
  setRefreshExpiryReader: 'test seam (#3326): injects engine/connect.js\'s refreshTokenExpiresAt reader so the forced-login proof (loginLanded) is asserted without the real macOS keychain; under node --test the default reads nothing.',
