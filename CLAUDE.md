...
| Work on web push notifications | `server.js` (thin proxy routes `/v1/push/subscribe` Bearer-forwarded + `/v1/push/vapid-key` cached); the coordinator owns subscriptions, encryption, and delivery: `kosmos-relay/coordinator/src/push.rs` (#718) |
