 ...
 * page gate (docs/browser-checks/) is not in yarn test, and 15 of the 47
 * checks that existed then were not in the gate (first counted as 27 of 46 by
 * matching literal run_one lines, which cannot see the stem loop in
 * browser-checks.sh -- search `for n in live-connect`; #812). The class that fires: a check asks for
