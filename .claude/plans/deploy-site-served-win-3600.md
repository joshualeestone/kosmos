...
`tools/test-deploy-site-served-win-3600.sh`, wired into `test:shell`. Twenty-one arms with a redirect-aware
...
zip bytes that do not hash to the published sha (A21).
