...
- **Item 14** — members card heading "Project members" → "Members".
- **Item 13** — files card heading "Files in this project" → "Files".
...
- **Item 12** — the Files and Tasks "View All" doors: both read "View All"
  ...
  tasks door said "View all tasks →"). New `.pj-viewall` class centres them and
  drops the `.linkish` underline for these two doors only.
...
- `web.consolidated-match-mock.test.js` asserts the composer hint is gone from
  both views (was: "stripped in consolidated only").
