...
Arm by arm:
- Unmodified guard: both new tests pass.
- Guard set to `if (false)`: the guard test reds, the control stays green.
- Restored: engine/connect.js diff empty, full server.connect.test.js 37/37.
