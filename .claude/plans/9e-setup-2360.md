...
origin/main:setup is unreadable, and only as UNPROVEN on a difference (never a hard FAIL) — and since
UNPROVEN also exits the check non-zero, a genuine mismatch is never silently passed.
