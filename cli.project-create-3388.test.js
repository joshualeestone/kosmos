...
async function cli(port, args) {
  ...
  try {
    ...
    if (!e || typeof e.code !== 'number') throw new Error('the CLI gave no exit code (' + ((e && (e.signal || e.code)) || 'unknown') + '): killed by the harness timeout, over the output buffer, or never started.');
